...
//unlink($dir.'/'.$pimage);
	...
	$sql=mysqli_query($conn,"update  products set ExampleProfile='$productimage' where ProductId='$pid' ");
...
$query=mysqli_query($conn,"select Name,ExampleProfile from products where ProductId='$pid'");
$cnt=1;
