...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$sql = mysqli_query($con, "UPDATE salon SET Name = '$name',Location = '$location',Description = '$description',Contacts = '$contacts' WHERE SalonId = '$salonid' ");
		$employeeid = $con->insert_id;
		$_SESSION['msg'] = "salon edited";
						...
						<div class="content">
							...
							<div class="module">
								...
								<div class="module-body">
                                    ...
                                    <?php 
                                    $salonid = $_GET['id'];
                                    $selectsalon=mysqli_query($con, "SELECT * FROM salon WHERE SalonId = $salonid");
                                    $row=mysqli_fetch_array($selectsalon);
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" placeholder="Enter salon Name" name="name"
													class="span8 tip" value="<?php echo $row['Name']; ?>"  required>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="number" placeholder="Enter contacts" name="contacts"
													class="span8 tip" value="<?php echo $row['Contacts']; ?>"  required>
											</div>
										</div>
										<div class="control-group">
